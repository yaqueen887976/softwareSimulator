...
public class ForceList extends JPanel implements ListSelectionListener
{
	...
	public static JTextField forceField;
	...
	class AddListener implements ActionListener, DocumentListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(name.equals("")|| name.startsWith(" ")|| alreadyInLIist(name)) {
		...
		protected boolean alreadyInLIist(String name) {return listModel.contains(name);}
